...
stargazer(regDetectFull, regDetectSub,
          ...
          out = '../figures/table_detection_warning.txt')
...
# gender
m3 = lm(exp2correct ~ as.factor(female), df)
vcov         = vcovHC(m3, "HC1")
...
# combined
m9 = lm(exp2correct ~ as.factor(exp2dfobv) + as.factor(Confidence) + as.factor(female)
...
stargazer(m1, m2, m3, m4, m5, m6, m7, m8, m9,
          ...
          dep.var.labels   = "Detection",
          out = '../submission/tables/table4_detection_warning_heterogeneity.doc')
