...
stargazer(m1, m2,
          ...
          type = 'text',
          covariate.labels = 
              c("Treatment", "Female", "Age x 1/10", "Aware of deepfakes",
                "Proficient with social media", "High level of internet use", "Familiar with actor"),
...
stargazer(m1, m2,
          ...
          header = F,
          covariate.labels = 
              c('Aware of deepfakes', 'Aware of deepfakes x Treatment',
                'Below median age', 'Below median age x Treatment'),
          se=list(afRobustSEs_m1, afRobustSEs_m2)
)
